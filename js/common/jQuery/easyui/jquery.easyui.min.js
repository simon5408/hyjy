...
$.fn.dialog.defaults=$.extend({},$.fn.window.defaults,{title:"新会话",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"必填项.",invalidMessage:null,rules:{email:{validator:function(_2fa){
