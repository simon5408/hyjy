					...
					<div class="rightSide">
						...
						<div class="zyjsDetail">
							...
							<div class="contentDiv">
								<div class="xxDiv"><span>专业名称:</span> 工程造价管理</div>
								<div class="xxDiv"><span>报考学费:</span> ￥9000/年</div>
								<div class="xxDiv"><span>毕业时间:</span> 1年至1.5年拿证</div>
						...
						<div class="kcjsDetail">
							<ul>
								...
								<li>03709马克思主义基本原理概论</li>
								<li>04184线性代数(经管类)</li>
								<li>04183概率论与数理统计(经管类)</li>
								<li>09469财经应用写作</li>
								<li>0015英语（二）</li>
								<li>04230建设监理导论</li>
								<li>03601服务营销学</li>
								<li>04231建设工程合同（含FIDIC）条款</li>
								<li>05963绩效管理</li>
