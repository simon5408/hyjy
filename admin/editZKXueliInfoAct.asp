...
exec="update zkxl_info set zk_type="&zk_type&",zk_level="&zk_level&",zk_name='"&zk_name&"',zk_zyjj='"&zk_zyjj&"',zk_price='"&zk_price&"',zk_time='"&zk_time&"',zk_khfz='"&zk_khfz&"',zk_bybz='"&zk_bybz&"',zk_kctd='"&zk_kctd&"',zk_bmdz='"&zk_bmdz&"',zk_kcjs='"&zk_kcjs&"',zk_kcap='"&zk_kcap&"',zk_date='"&zk_date&"' where zk_id= "&zk_id&""

conn.execute exec
conn.close
set conn=nothing
response.write("<script language=javascript>alert('±à¼­³É¹¦!');window.location.href='listZKXueliInfo.asp';</script>")
%>
