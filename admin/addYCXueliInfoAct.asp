...
exec="insert into crxl_info (yc_name, yc_info, yc_xzlx, yc_skfs, yc_zysz, yc_xznx, yc_bdtj, yc_bfzs, yc_bmzx, yc_bmxz, yc_xlcc, yc_xlxw, yc_date) values('"&ycName&"','"&ycInfo&"','"&ycXzlx&"','"&ycSkfs&"','"&ycZysz&"','"&ycXznx&"','"&ycBdtj&"','"&ycBfzs&"','"&ycBmzx&"','"&ycBmxz&"','"&ycXlcc&"','"&ycXlxw&"','"&ycDate&"')"
conn.execute exec
conn.close
set conn=nothing
